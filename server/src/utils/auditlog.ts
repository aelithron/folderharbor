...
export type AuditBody = Partial<{ filePath: string, oldPath: string } | { id: number, accessLevel: "full" | "limited", newContents: unknown } | { authSuccess: boolean } | { newConfigItems: Partial<z.infer<typeof Config>> }>;
