import { faGlobe, faPlay, faStar, faUpRightFromSquare } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-2">
        <div className="flex flex-col gap-2 items-center justify-center text-center">
          ...
          <div className="grid grid-cols-2 gap-4 my-4">
            <div className="flex flex-col gap-2 bg-slate-700 p-3 rounded-xl text-center">
              <h1 className="text-lg font-semibold">Open Demo Panel</h1>
              <a href="https://panel.fh.novatea.dev" target="_blank" className="bg-violet-500 hover:text-sky-500 p-1 rounded-xl"><FontAwesomeIcon icon={faUpRightFromSquare} /> Demo Panel</a>
            </div>
            <div className="flex flex-col gap-2 bg-slate-700 p-3 rounded-xl text-center">
              <h1 className="text-lg font-semibold">Download {version ? version.name : "Web Panel"}</h1>
              <a href="https://github.com/aelithron/folderharbor/blob/main/web#setup" target="_blank" className="bg-violet-500 hover:text-sky-500 p-1 rounded-xl"><FontAwesomeIcon icon={faUpRightFromSquare} /> Setup Guide</a>
            </div>
          </div>
        </div>
