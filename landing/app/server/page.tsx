  ...
  return (
    <main className="flex flex-col min-h-screen p-8 md:px-16">
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-2">
        ...
        <div className="flex justify-center md:col-span-2"><Image src={serverPhoto} alt="A stylized screenshot of two macOS Finder windows, showing the FolderHarbor server working." loading="eager" className="rounded-xl md:w-3/4" /></div>
      </div>
    </main>
  );
}
